...
@implementation Cell_menu_icon_box
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        //下边小图标及数字
        {
            float top = self.frame.size.height * 0.9;
        ...
        spaceView.frame = CGRectMake(20, self.frame.size.height-1, WIDTH-40, 1);
