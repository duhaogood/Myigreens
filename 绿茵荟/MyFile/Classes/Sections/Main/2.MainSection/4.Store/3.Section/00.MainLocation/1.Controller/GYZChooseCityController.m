...
-(NSMutableArray *) cityDatas{
    if (_cityDatas == nil) {
        NSArray *array = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"CityLocationData" ofType:@"plist"]];
        ...
        for (NSDictionary *groupDic in array) {
            ...
            for (NSDictionary *dic in [groupDic objectForKey:@"citys"]) {
                ...
                city.cityID = [dic objectForKey:@"cityCode"];
                city.cityName = [dic objectForKey:@"cityName"];
                city.shortName = [dic objectForKey:@"cityName"];
